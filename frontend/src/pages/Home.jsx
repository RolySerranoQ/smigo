  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      >
        ...
        <div className="container px-4 z-10 animate-float">
          <span className="bg-smigo-yellow text-black px-4 py-2 rounded-full font-bold text-xs md:text-sm uppercase mb-6 inline-block shadow-lg tracking-wider">
          ...
          <h1 className="text-4xl md:text-7xl font-extrabold mb-6 leading-tight drop-shadow-lg">
            ...
            <span className="text-smigo-yellow">Seguridad para tu Hato</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link to="/login" className="bg-smigo-yellow text-smigo-dark px-8 py-4 rounded-full font-black text-lg hover:bg-white hover:text-smigo-green transition transform hover:-translate-y-1 shadow-xl inline-flex items-center justify-center gap-2">
              Ver a mis Vacas <ArrowRight />
            </Link>
            <Link to="/login" className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-smigo-green transition">
              Registrarse Gratis
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 container mx-auto px-4 -mt-20 relative z-20">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-smigo-green mb-4">Hermandad Tecnológica</h2>
            <p className="text-gray-500 text-lg">Un sistema diseñado para darte la mano cuando más lo necesitas.</p>
          </div>
...
function FeatureCard({ icon, title, desc, color, bg }) {
  return (
    <div className="p-6 rounded-2xl border border-gray-100 hover:border-smigo-green hover:shadow-lg transition duration-300 text-center group">
      <div className={`w-20 h-20 ${bg} ${color} rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition duration-300`}>
        {icon}
      </div>
